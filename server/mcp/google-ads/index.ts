...
export function createGoogleAdsMCPServer() {
  ...
  server.registerTool(
    'get_campaigns',
    {
      description: 'Returns performance data for all Google Ads campaigns',
      inputSchema: {
  ...
  server.registerTool(
    'get_search_term_report',
    {
      description: 'Returns the search terms report showing what users actually searched for',
      inputSchema: {
  ...
  server.registerTool(
    'get_keyword_performance',
    {
      description: 'Returns performance data for keywords in a specific campaign',
      inputSchema: {
  ...
  server.registerTool(
    'upload_offline_conversions',
    {
      description: 'Uploads offline conversion data to Google Ads to close the attribution loop. REQUIRES HUMAN REVIEW before calling.',
      inputSchema: {
  ...
  server.registerTool(
    'add_negative_keywords',
    {
      description: 'Adds negative keywords to a Google Ads campaign. REQUIRES HUMAN APPROVAL — always dry_run first.',
      inputSchema: {
